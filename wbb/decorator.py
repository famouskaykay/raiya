...
from wbb import BOT_USERNAME, dp
from wbb.config import get_bool_key
from wbb.modules.error import parse_update
from wbb.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("wbb.utils.filters." + module_name)
